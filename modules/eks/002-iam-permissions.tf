...
resource "aws_iam_role" "eks_node_group" {
  name = "${var.ProjectName}-eks-node-group-role"
...
resource "aws_iam_role" "sa-role" {
  name = "${var.ProjectName}-eks-sa-role"
  assume_role_policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      {
